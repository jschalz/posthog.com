const { initializaGlobalState, getCoreSupportsOnPluginInit } = require('./options')
const { createCloudinaryAssetType, createCloudinaryAssetNodes } = require('./node-creation')
...
exports.pluginOptionsSchema = ({ Joi }) => {
    return Joi.object({
        ...
        defaultTransformations: Joi.array().items(Joi.string()).default(['c_fill', 'g_auto', 'q_auto']),
    })
}
