...
const { getAssetMetadata, getUrlAsBase64Image, getAssetAsTracedSvg } = require('./asset-data')
...
describe('getAssetMetaData', () => {
    ...
    it('fetches the correct metadata url', async () => {
        ...
        expect(probe).toHaveBeenCalledWith(
            expect.stringContaining('res.cloudinary.com/cloud-name/image/upload/f_auto,e_grayscale/public-id')
        )
    })
...
describe('getUrlAsBase64Image', () => {
    ...
    it('returns the base64 data url', async () => {
        ...
        expect(base64).toBe('data:image/jpeg;base64,NDkgMjcgNmQgMjAgNjEgMjAgNzMgNzQgNzIgNjkgNmUgNjcgMjE=')
    })
